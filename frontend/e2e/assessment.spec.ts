...
test.describe('Assessment Flow', () => {
  ...
  test('should complete an assessment successfully', async ({ page }) => {
    ...
    // 3. Simulate Ranking (Drag and Drop)
    // We'll drag the first item to the position of the last item
    const firstOption = page.getByText('I like to deal with my feelings');
    const lastOption = page.getByText('I like to be doing things');
    ...
    // Drag and drop
    await firstOption.dragTo(lastOption);
