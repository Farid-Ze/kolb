  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white contain-layout">
      ...
      >
        ...
        <Link 
          to="/" 
          className="group inline-block gpu-transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0f] rounded-sm"
          aria-label="Zenotika - Go to homepage"
        >
          <h1 className="font-headline text-lg sm:text-xl md:text-2xl font-bold tracking-tighter text-white group-hover:text-indigo-400 gpu-transition">
            ZENOTIKA<span className="text-indigo-400">™</span>
          </h1>
          ...
          {isAuthenticated ? (
            <>
              ...
              <NavLink
                to="/me"
                className={({ isActive }) =>
                  `inline-flex items-center justify-center gap-2 group min-w-[44px] min-h-[44px] px-2 gpu-transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded-sm ${
            ...
            <Link 
              to="/auth" 
              className="relative inline-flex items-center justify-center cursor-pointer group min-w-[44px] min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded-sm"
              aria-label="Sign in"
            >
              <div className="inline-flex gap-[3px] sm:gap-1" aria-hidden="true">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-white rounded-full group-hover:bg-indigo-400 gpu-transition"></div>
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-white rounded-full opacity-60 group-hover:bg-indigo-400 group-hover:opacity-100 gpu-transition"></div>
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-white rounded-full opacity-60 group-hover:bg-indigo-400 group-hover:opacity-100 gpu-transition"></div>
              </div>
              <span className="ml-3 font-ui text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-white group-hover:text-indigo-400 gpu-transition hidden md:inline">
                Sign In
              </span>
            </Link>
          )}
