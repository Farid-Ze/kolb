                                ...
                                >
                                    <GlassMaterial intensity="high" className="p-8 md:p-12 flex flex-col gap-8 h-full">
                                        ...
                                        <div className="flex flex-col gap-4">
                                            {currentQuestion.options.map((option: AssessmentItemOption) => {
                                                        ...
                                                        <div className="flex gap-2">
                                                            {[1, 2, 3, 4].map(rank => (
                                                                <button
                                                                    ...
                                                                    className={`w-8 h-8 rounded-full border flex items-center justify-center transition-all ${currentRank === rank
