...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_gamification_badges_slug'), 'gamification_badges', ['slug'], unique=True)
    op.create_table('growth_challenges',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('assessment_item_responses',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    # op.drop_table('engine_scoring_rules')
    # op.drop_table('engine_forms')
    # op.drop_table('engine_instruments')
    # op.drop_table('engine_item_options')
    # op.drop_table('engine_scales')
    # op.drop_table('engine_items')
    # op.drop_table('engine_pages')
