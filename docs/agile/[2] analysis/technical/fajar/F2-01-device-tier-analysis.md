...
> |-----------|--------|--------|
> | Device Tiers (1-4) | ⚠️ **CLASSIFICATION** | Derived from F1-01 findings |
> | Market Share Estimates | ⚠️ **INDUSTRY** | Global device stats (2020) |
> | Hardware Requirements | ✅ **VERIFIED** | WebGL 2.0 Docs + A1-02 |
> | Performance Metrics | ⚠️ **ESTIMATED** | Extrapolated from F1-01 Tests |
> | FPS Targets | ✅ **VERIFIED** | discoverthreejs.com, MDN WebGL Best Practices |
...
**Sources:**
- https://discoverthreejs.com/tips-and-tricks/ (Three.js official learning resource)
- https://developer.mozilla.org/en-US/docs/Web/API/WebGL_API/WebGL_best_practices (MDN)

### Frame Rate Targets (VERIFIED)

| FPS | Frame Time | Target Use Case | Verification |
|-----|------------|-----------------|--------------|
| **60 FPS** | 16.67ms | Smooth desktop experience | ✅ discoverthreejs.com |
| **30 FPS** | 33.33ms | Minimum acceptable mobile | ✅ discoverthreejs.com |
| **<30 FPS** | >33ms | Performance issues | ⚠️ Needs optimization |

### WebGL System Limits (MDN Verified Minimums)

| Parameter | Minimum Guaranteed | Note |
|-----------|-------------------|------|
...
### Mobile-Specific Performance Considerations (VERIFIED)

From discoverthreejs.com and MDN:
- **High-DPI devices (5x pixel ratio)**: Limit max pixel ratio to 2-3 for performance ✅
- **Transparent objects**: Slow on all devices, especially mobile ✅
- **Point light shadows**: Require 6 render passes (very expensive on mobile) ✅
- **WebGL context loss**: More common on mobile, must handle gracefully ✅
- **Thermal throttling**: Mobile GPUs throttle under sustained load (device-specific) ✅
...
**From F1-01**: Desktop (GTX 1060/RTX 2060), iPhone 12 Pro/13 Pro, iPad Pro (M1)
...
**From F1-01**: Laptop (Intel UHD 630), iPhone 8/XR, Galaxy S21, MacBook Air M1
...
**From F1-01**: Galaxy A52, Redmi Note 10 (20-30 FPS observed)
...
**From F1-03**: IE11 (blocked), Opera Mobile (poor support), Devices without WebGL 2.0
